...
func (_mock *InventoryClient) ListParts(ctx context.Context, filter *model.PartsFilter) ([]*model.Part, error) {
...
func (_c *InventoryClient_ListParts_Call) RunAndReturn(run func(ctx context.Context, filter *model.PartsFilter) ([]*model.Part, error)) *InventoryClient_ListParts_Call {
	_c.Call.Return(run)
	return _c
}
